...
export const ALL_PROPERTIES = [
  ...
  },
  {
    ...
    address: '789 Business District, San Francisco, CA',
    price: 18500000,
    bedrooms: 0,
    bathrooms: 16,
    area: 32000,
    description: 'Modern glass office tower with panoramic bay views and state-of-the-art facilities.',
  ...
  },
  {
    ...
    address: '456 Culinary Avenue, New Orleans, LA',
    price: 3200000,
    bedrooms: 0,
    bathrooms: 4,
    area: 4500,
    description: 'Turnkey restaurant space with high-end kitchen equipment and stylish dining area.',
  ...
  {
    id: 25,
    title: 'Waterfront Hotel Property',
    address: '321 Harbor View, San Diego, CA',
    price: 22500000,
    bedrooms: 120,
    bathrooms: 130,
    area: 75000,
    description: 'Luxury hotel property with private beach access and comprehensive amenities.',
  ...
  },
  {
    ...
    address: '555 Shopping Plaza, Chicago, IL',
    price: 9800000,
    bedrooms: 0,
    bathrooms: 12,
    area: 28000,
    description: 'Multi-level retail complex with established anchor tenants and high foot traffic.',
  ...
  },
  {
    ...
    address: '789 Healthcare Boulevard, Houston, TX',
    price: 14500000,
    bedrooms: 0,
    bathrooms: 24,
    area: 35000,
    description: 'Purpose-built medical campus with specialized facilities for healthcare providers.',
  ...
  },
  {
    ...
    address: '101 Silicon Avenue, Austin, TX',
    price: 7200000,
    bedrooms: 0,
    bathrooms: 8,
    area: 12000,
    description: 'Modern workspace designed for tech startups with collaboration areas and advanced infrastructure.',
    image: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
    featured: true,
    type: 'commercial',
    isNew: true,
  },
  {
    ...
    address: '2000 Logistics Parkway, Memphis, TN',
    price: 6800000,
    bedrooms: 0,
    bathrooms: 6,
    area: 85000,
    description: 'Strategic distribution facility with loading docks and proximity to major transportation routes.',
  ...
  {
    id: 30,
    title: 'Boutique Fitness Center',
    address: '333 Wellness Way, Denver, CO',
    price: 2400000,
    bedrooms: 0,
    bathrooms: 8,
    area: 5500,
    description: 'Fully equipped fitness facility with studio spaces and premium equipment.',
